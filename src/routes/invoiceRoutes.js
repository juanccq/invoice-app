...
import InvoiceController, { validateInvoiceMiddleware } from '../controllers/invoiceController.js';
...
router.post( '/', roleMiddleware(['Accountant', 'Administrator']), validateInvoiceMiddleware, InvoiceController.createInvoice );
